...
Your task is to plan the next 1 to {max_goals} actions to react in a lifelike manner to the most recent user input, based on your personality, and current mood. 
